...
export default function FormAuth({
  ...
  const { formAuth } = useFormAuth(setLoading);
  ...
  return (
    <div className={"flex pb-10 h-[100vh] flex-col justify-between"}>
      <div>
      ...
      <div className={"card items-center"}>
        {loading ? (
          ...
          <button className={"flex btn h-20 w-full"} onClick={handleAuthGoogle}>
            <svg
